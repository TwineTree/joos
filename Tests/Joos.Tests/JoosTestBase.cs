...
namespace Joos.Tests
{
    public abstract class JoosTestBase : AbpIntegratedTestBase
    {
        protected JoosTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<JoosApplicationModule>();
            modules.Add<JoosDataModule>();
        }

        public void UsingDbContext(Action<JoosDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<JoosDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<JoosDbContext, T> func)
        {
            T result;
